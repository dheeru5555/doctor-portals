...
import { fetchAllBillables } from "../../../../../redux/actions/appointmentAction";
...
function AddItem(props) {
  ...
  const { classes, consultationDetails, billingId, onChangeValue, billables } = props;
  ...
  const saveProduct = () => {
    let addBillItem = {
      patient_id: props.consultationDetails.patient.id,
      clinic_id: props.consultationDetails.clinic.id,
...
export default connect(mapStateToProps, { fetchAllBillables })(withStyles(styles)(AddItem));
