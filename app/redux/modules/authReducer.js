...
export default function authReducer(state = new AuthState(), action = {}) {
  switch (action.type) {
    ...
    case "BASIC_DOCTOR_INFO":
      return Object.assign({}, state, { basicDoctorInfo: action.basicDoctorInfo });

    case "DOCTOR_REG_INFO":
      return Object.assign({}, state, { doctorRegInfo: action.doctorRegInfo });

    case "UPDATE_HASHED_KEY":
