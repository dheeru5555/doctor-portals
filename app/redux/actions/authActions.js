...
export const submitBasicDocInfo = (basicDoctorInfo) => dispatch => {
  dispatch({
    type: 'BASIC_DOCTOR_INFO',
    basicDoctorInfo,
  });
}

export const submitDoctorRegInfo = (doctorRegInfo) => dispatch => {
  dispatch({
    type: 'DOCTOR_REG_INFO',
    doctorRegInfo,
  });
}

export const updateUserHashedKey = (hashedKey) => dispatch => {
  dispatch({
    type: 'UPDATE_HASHED_KEY',
    hashedKey,
  });
}
