...
function AddClinicDialog(props) {
    ...
    const [isAdd, setIsAdd] = React.useState(clinicId !== null ? true : false)
    ...
    const [renderClinicState, setRenderClinicState] = React.useState({
        name: "",
        phones: "",
        google_map_url: "",
        latitude: 17.4126274,
    ...
    useEffect(() => {
        if (clinicId !== null && singleCLinicDetails == null) {
        }
    ...
    const intermediateClinicData = { ...addClinicState };
    const handleImageUploads = (targetName, targetValue) => {

        if ((targetName === "logo") && (targetValue) && (targetValue !== "")) {
            intermediateClinicData[targetName] = targetValue;
        }

        if ((targetName === "doctor_signature") && (targetValue) && (targetValue !== "")) {
            intermediateClinicData[targetName] = targetValue;
        }

        if ((targetName === "header_image") && (targetValue) && (targetValue !== "")) {
            intermediateClinicData[targetName] = targetValue;
        }

        if ((targetName === "footer_image") && (targetValue) && (targetValue !== "")) {
            intermediateClinicData[targetName] = targetValue;
        }

        if ((targetName === "photos") && (targetValue) && (targetValue !== "")) {
            intermediateClinicData[targetName].push(targetValue);
        }

        setAddClinicState(intermediateClinicData);
    }

    const handleImageDelete = (targetName, targetValue) => {
        const intermediateClinicData = { ...addClinicState };

        if (targetName === "logo") {
            intermediateClinicData[targetName] = targetValue;
        } else if (targetName === "doctor_signature") {
            intermediateClinicData[targetName] = targetValue;
        } else if (targetName === "header_image") {
            intermediateClinicData[targetName] = targetValue;
        } else if (targetName === "footer_image") {
            intermediateClinicData[targetName] = targetValue;
        } else {
            const photosList = [...intermediateClinicData.photos];
            const index = photosList.indexOf(targetValue);
            if (index > -1) {
                photosList.splice(index, 1);
            }
            intermediateClinicData["photos"] = photosList;
        }
                            ...
                            <Grid container spacing={3} style={{ padding: 20, background: '#fff', borderRadius: 10 }}>
                                ...
                                <Grid item xs={12} sm={12} md={6}>
                                    ...
                                    <Grid container spaccing={4}>
                                        <Grid item md={3} className={classes.uploadCont}>
                                            {
                                                (
                                                    (renderClinicState.logo === null) ||
                                                    (renderClinicState.logo.length === 0)
                                                ) ?
                                                    (
                                                        <DropZoneWrapper>
                                                            <DropzoneArea
                                                                ...
                                                                filesLimit={1}
                                                                Icon={Add}
                                                                dropzoneText="Clinic Logo*"
                                                            />
                                                            <label className={classes.dropLabel}>Logo*</label>
                                                            <FormHelperText style={{ color: 'red' }}>
                                                                {
                                                                    ((errorMessages !== null) && (errorMessages.logo)) ? errorMessages.logo[0] : ""
                                                                }
                                                            </FormHelperText>
                                                        </DropZoneWrapper>
                                                    )
                                                    ...
                                                    (
                                                        <>
                                                            <img
                                                                src={
                                                                    (addClinicState.logo && (addClinicState.logo.length > 0)) ? imagesOrDocs.clinic_images_prefix_url + addClinicState.logo : null
                                                                }
                                                                alt="Clinic Logo"
                                                            ...
                                                            {/* <IconButton className={classes.updateImage}>
                                                                <EditIcon />
                                                            </IconButton> */}
                                                        </>
                                                    )
                                        ...
                                        <Grid item md={3} className={classes.uploadCont}>
                                            {
                                                (
                                                    (renderClinicState.doctor_signature === null) ||
                                                    (renderClinicState.doctor_signature.length === 0)
                                                ) ?
                                                    (
                                                        <DropZoneWrapper>
                                                            <DropzoneArea
                                                                ...
                                                                acceptedFiles={['image/*']}
                                                                onDelete={() => handleImageDelete("doctor_signature", "")}
                                                                filesLimit={1}
                                                                Icon={Add}
                                                                dropzoneText="Signature*"
                                                            />
                                                            <label className={classes.dropLabel}>Signature*</label>
                                                            <FormHelperText style={{ color: 'red' }}>
                                                                {
                                                                    ((errorMessages !== null) && (errorMessages.doctor_signature)) ? errorMessages.doctor_signature[0] : ""
                                                                }
                                                            </FormHelperText>
                                                        </DropZoneWrapper>
                                                    )
                                                    ...
                                                    (
                                                        <>
                                                            <img
                                                                src={imagesOrDocs.clinic_images_prefix_url + addClinicState.doctor_signature}
                                                                alt="Signature"
                                                                className={classes.image}
                                                            />
                                                            <Typography align="center" color="inherit">
                                        ...
                                        <Grid item md={3} className={classes.uploadCont}>
                                            {
                                                (
                                                    (renderClinicState.photos === null) ||
                                                    (renderClinicState.photos.length === 0)
                                                ) ?
                                                    (
                                                        <DropZoneWrapper>
                                                            <DropzoneArea
                                                                onChange={(files) => handleImageUploads(
                                                                    "photos",
                                                                    (files[0]) ? files[0] : ""
                                                                )
                                                                }
                                                                acceptedFiles={['image/*']}
                                                                onDelete={(file) => handleImageDelete("photos", file)}
                                                                filesLimit={1}
                                                                Icon={Add}
                                                                dropzoneText="Clinic Photo"
                                                            />
                                                            <label className={classes.dropLabel}>Cover</label>
                                                        </DropZoneWrapper>
                                                    )
                                                    :
                                                    (
                                                        <>
                                                            <img
                                                                src={imagesOrDocs.clinic_images_prefix_url + addClinicState.photos[0]}
                                                                alt="Clinic Photo 1"
                                                                className={classes.image}
                                                            />
                                                            <Typography align="center" color="inherit">
                                                    ...
                                                    (
                                                        <DropZoneWrapper>
                                                            <DropzoneArea
                                                                ...
                                                                dropzoneText="Clinic Photo"
                                                            />
                                                            <label className={classes.dropLabel}>Photo</label>
                                                        </DropZoneWrapper>
                                                    )
                                                    :
                                                    (
                                                        <>
                                                            <img
                                                                src={imagesOrDocs.clinic_images_prefix_url + addClinicState.photos[1]}
                                                                alt="Clinic Photo 2"
                                                                className={classes.image}
                                                            />
                                                            <Typography align="center" color="inherit">
                                        ...
                                        <Grid item md={3} className={classes.uploadCont}>
                                            {
                                                (
                                                    (renderClinicState.header_image === null) ||
                                                    (renderClinicState.header_image.length === 0)
                                                ) ?
                                                    (
                                                        <DropZoneWrapper>
                                                            <DropzoneArea
                                                                ...
                                                                acceptedFiles={['image/*']}
                                                                onDelete={(file) => handleImageDelete("header_image", file)}
                                                                filesLimit={1}
                                                                Icon={Add}
                                                                dropzoneText="Clinic Photo"
                                                            />
                                                            <label className={classes.dropLabel}>Header Image*</label>
                                                            <FormHelperText style={{ color: 'red' }}>
                                                                {
                                                                    ((errorMessages !== null) && (errorMessages.header_image)) ? errorMessages.header_image[0] : ""
                                                                }
                                                            </FormHelperText>
                                                        </DropZoneWrapper>
                                                    )
                                                    ...
                                                    (
                                                        <>
                                                            <img
                                                                src={imagesOrDocs.clinic_images_prefix_url + addClinicState.header_image}
                                                                alt="Header Image"
                                                                className={classes.image}
                                                            />
                                                            <Typography align="center" color="inherit">
                                        ...
                                        <Grid item md={3} className={classes.uploadCont}>
                                            {
                                                (
                                                    (renderClinicState.footer_image === null) ||
                                                    (renderClinicState.footer_image.length === 0)
                                                ) ?
                                                    (
                                                        <DropZoneWrapper>
                                                            <DropzoneArea
                                                                ...
                                                                acceptedFiles={['image/*']}
                                                                onDelete={(file) => handleImageDelete("footer_image", file)}
                                                                filesLimit={1}
                                                                Icon={Add}
                                                                dropzoneText="Clinic Photo"
                                                            />
                                                            <label className={classes.dropLabel}>Footer Image*</label>
                                                            <FormHelperText style={{ color: 'red' }}>
                                                                {
                                                                    ((errorMessages !== null) && (errorMessages.footer_image)) ? errorMessages.footer_image[0] : ""
                                                                }
                                                            </FormHelperText>
                                                        </DropZoneWrapper>
                                                    )
                                                    ...
                                                    (
                                                        <>
                                                            <img
                                                                src={imagesOrDocs.clinic_images_prefix_url + addClinicState.footer_image}
                                                                alt="Footer Image"
                                                                className={classes.image}
                                                            />
                                                            <Typography align="center" color="inherit">
                                        ...
                                        <FormHelperText style={{ color: 'red' }}>
                                            {
                                                (
                                                    (errorMessages !== null) &&
                                                    (errorMessages["photos.0"] || errorMessages["photos.1"] || errorMessages["photos.2"])) ?
                                                    errorMessages["photos.0"] || errorMessages["photos.1"] || errorMessages["photos.2"]
                                                    :
                                                    ""
                                            }
