...
function Vitals(props) {
    ...
    const handleVitalAdd = async (event, greenLcl, greenUcl, orangeLcl, orangeUcl, redLcl, redUcl) => {
        ...
        renderSeverity(value, greenLcl, greenUcl, orangeLcl, orangeUcl, redLcl, redUcl);
    ...
    const addNewVital = () => {
        const reqData = { ...newVital };

        api.ACCOUNTS_URI().post('appointments/consultation/addNewVital', reqData)
            .then((resp) => {
